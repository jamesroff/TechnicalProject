...
pres = ((p(2))/(p(8)*(9)))^2;
[t,y,t_col,t_end3] = QuarterWaveSimulation(p,[1.01,0,pres,0,0],[0,1.5],[0,25],'Initial',true);
...
% x_lim = xlim;
% plot(x_lim,[1,1]*1.5,'k-.')
% xlim(x_lim);
ylim(y_lim);
legend('Simulation Results','Initial Ratio Prediction','Mean Ratio Predicition','Final Ratio Prediction','location','southeast')
...
legend('Simulation Results','Initial Ratio Prediction','Mean Ratio Predicition','Final Ratio Prediction','location','northwest')